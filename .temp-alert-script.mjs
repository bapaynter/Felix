...
cron.add({"name":"Critical Health Alert","schedule":{"kind":"at","at":"2026-02-13T04:06:01.836Z"},"payload":{"kind":"systemEvent","text":"🚨 CRITICAL HEALTH ALERT\n\n🔴 MEMORY: Memory usage at 92% (threshold: 90%)\n   💡 Suggestion: Restart heavy processes, check for memory leaks\n\nCheck health logs: /home/pi/.openclaw/workspace/memory/health-critical.log"},"sessionTarget":"main","enabled":true}).then(() => {
